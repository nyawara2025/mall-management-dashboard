  ...
  if (cropsView === 'menu') {
    return (
      <div className="space-y-4 animate-fadeIn text-left">
        {/* Weather Indicator Banner widget */}
        ...
        {/* Modular Grid View Operational Actions list triggers */}
        <div className="grid grid-cols-1 gap-3">
          ...
          >
            <div>
              <h4 className="text-xs font-black text-slate-900 uppercase tracking-wider group-hover:text-emerald-600 transition-colors">Input Management</h4>
              <p className="text-[11px] text-slate-400 font-medium mt-0.5">Log Seeds, Fertilizers, Manure & Chemical Sprays</p>
            </div>
          ...
          >
            <div>
              <h4 className="text-xs font-black text-slate-900 uppercase tracking-wider group-hover:text-emerald-600 transition-colors">Task Schedule & Alerts</h4>
              <p className="text-[11px] text-slate-400 font-medium mt-0.5">Manage Land Prep, Spraying Cycles & Harvest Deadlines</p>
            </div>
            <span className="text-lg">📅</span>
          </button>
        </div>
