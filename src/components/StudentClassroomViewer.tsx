    ...
    try {
      const response = await fetch('https://n8n.tenear.com/webhook/interactive-questions', {
        ...
        body: JSON.stringify({
          ...
          student_id: activeClassroom.student_id,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2">
          <div className="w-full h-[280px] sm:h-[380px] rounded-2xl overflow-hidden bg-slate-950 border border-slate-200 shadow-inner">
            <iframe
              src={"https://meet.jit.si/" + secureEmbedRoomToken + "#config.startWithAudioMuted=true&config.startWithVideoMuted=true&interfaceConfig.TOOLBAR_BUTTONS=[\"microphone\",\"camera\",\"raisehand\"]"}
