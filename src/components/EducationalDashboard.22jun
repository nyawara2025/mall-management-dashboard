...
export const EducationalDashboard = ({ shopId }: { shopId: number }) => {
  ...
  // ✅ THE RE-INTEGRATED REGISTER STUDENT HANDLER BLOCK live and scoped!
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 bg-white p-8 rounded-3xl shadow-xl border border-gray-100 h-fit text-left">
            ...
            <div className="flex flex-col gap-4">
              <div onClick={() => handleGeneralAction('Add Student')} className="p-5 border-2 border-dashed border-gray-100 rounded-2xl hover:border-emerald-200 transition-all cursor-pointer group flex items-start gap-4">
              ...
              <div onClick={() => handleGeneralAction('Student Database')} className="p-5 border-2 border-dashed border-gray-100 rounded-2xl hover:border-emerald-200 transition-all cursor-pointer group flex items-start gap-4">
                <div className="p-3 bg-gray-50 rounded-xl group-hover:bg-emerald-50 transition-colors"><LayoutGrid className="text-gray-400 group-hover:text-emerald-600" size={24} /></div>
                <div>
