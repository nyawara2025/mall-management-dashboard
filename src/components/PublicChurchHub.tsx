...
const ProfileCard = ({ userData }: { userData: MemberData }) => {
  return (
    <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 text-center relative overflow-hidden">
      ...
      {/* Info Rows */}
      <div className="space-y-4">
        <div className="bg-gray-50/50 p-4 rounded-2xl flex items-start gap-4 text-left border border-gray-100/50">
          <div className="p-2 bg-white rounded-xl shadow-sm text-blue-600"><ShieldCheck size={18}/></div>
          <div>
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Zone</p>
            <p className="font-bold text-gray-800">{userData.zone_name}</p>
          </div>
        </div>

        <div className="bg-gray-50/50 p-4 rounded-2xl flex items-start gap-4 text-left border border-gray-100/50">
          <div className="p-2 bg-white rounded-xl shadow-sm text-blue-600"><Users size={18}/></div>
          <div>
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Current Ministry</p>
            <p className="font-bold text-gray-800">{userData.ministry_name}</p>
          </div>
        </div>
      </div>
    </div>
