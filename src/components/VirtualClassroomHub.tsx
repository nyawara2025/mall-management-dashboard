        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-in fade-in duration-300">
          <div className="lg:col-span-2">
            <div className="w-full h-[460px] rounded-2xl overflow-hidden bg-slate-950 border border-slate-200 relative shadow-inner">
              <iframe
                src={"https://8x8.vc" + secureEmbedRoomToken + "#config.startWithAudioMuted=false&config.startWithVideoMuted=false&config.disableDeepLinking=true&config.deploymentInfo.userRoles.isTokenAuthUser=true&config.prejoinPageEnabled=false&interfaceConfig.TOOLBAR_BUTTONS=[microphone,camera,raisehand,desktop,hangup,chat]"}
