      ...
      {isLeader && (
        <div className="animate-in fade-in slide-in-from-top-2">
          ...
          >
            ...
            <option value="Ministry">{userData?.ministry_name} Ministry Event</option>
            <option value="Department">Departmental Activity</option>
            <option value="Zone">{userData?.zone_name} Meeting</option>
          </select>
        </div>
      )}
