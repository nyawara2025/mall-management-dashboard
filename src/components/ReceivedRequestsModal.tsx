      ...
      <div className="bg-white w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl">
        ...
        <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
          {loading ? (
            ...
            requests.map((req) => (
              <div key={req.id} className="p-4 bg-gray-50 rounded-2xl border border-gray-100 mb-4">
                ...
                {replyingTo === req.id && (
                  <div className="mt-4 pt-4 border-t border-gray-200">
                    <textarea
                      className="w-full p-3 text-sm bg-white border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-blue-500"
